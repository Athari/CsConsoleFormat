    ...
    public sealed class DockTests : ElementTestsBase
    {
        ...
        public void RenderSpiral()
        {
            var dock = new Dock {
                Children = {
                    new Fill {
                        Char = 'a', Width = 4, Margin = new Thickness(1, 1, 0, 1),
                        [Dock.ToProperty] = DockTo.Left,
                    },
                    new Fill {
                        Char = 'b', Height = 3, Margin = new Thickness(1, 1, 1, 0),
                        [Dock.ToProperty] = DockTo.Top,
                    },
                    new Fill {
                        Char = 'c', Width = 2, Margin = new Thickness(0, 1, 1, 1),
                        [Dock.ToProperty] = DockTo.Right,
                    },
                    new Fill {
                        Char = 'd', Height = 1, Margin = new Thickness(1, 0, 1, 1),
                        [Dock.ToProperty] = DockTo.Bottom,
                    },
                    new Fill {
                        Char = 'e', Margin = 1, Width = 2, Height = 2,
                    },
                }
            };
