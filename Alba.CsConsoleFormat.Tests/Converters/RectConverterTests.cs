...
namespace Alba.CsConsoleFormat.Tests
{
    public sealed class RectConverterTests
    {
        ...
        public void ConvertFromInvalidSourceFormat()
        {
            ...
            new Action(() => _converter.ConvertFrom("0 0 0 -1")).Should().Throw<FormatException>().WithMessage("*height*");
        }
        ...
        {
            new Action(() => _converter.ConvertTo(new Rect(), typeof(int))).Should().Throw<NotSupportedException>();
        }
